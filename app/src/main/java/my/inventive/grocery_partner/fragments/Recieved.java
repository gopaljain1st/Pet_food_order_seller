...
public class Recieved extends Fragment {
    RecyclerView rv;
    ArrayList<Order> al;
    RecyclerView.Adapter<RecievedAdapter.orderAdapterViewHolder>adapter;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        adapter=new RecievedAdapter(getContext(),al);
