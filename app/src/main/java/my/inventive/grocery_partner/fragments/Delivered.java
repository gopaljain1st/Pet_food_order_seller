...
import my.inventive.grocery_partner.adapters.DeliverdOrderAdapter;
import my.inventive.grocery_partner.adapters.ShipeedAdapter;
...
public class Delivered extends Fragment
{
    RecyclerView rv;
    ArrayList<Order> al;
    RecyclerView.Adapter<DeliverdOrderAdapter.orderAdapterViewHolder>adapter;
