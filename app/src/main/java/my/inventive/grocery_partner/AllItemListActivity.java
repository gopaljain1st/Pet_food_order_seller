...
import my.inventive.grocery_partner.adapters.ItemListAdapter;
...
public class AllItemListActivity extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pd.show();
        String url = "https://inventivepartner.com/petmart/fetchSellerItem.php";
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String u="https://inventivepartner.com/petmart/images/"+s;
