...
public class PackedAdapter extends RecyclerView.Adapter<PackedAdapter.PackedAdapterViewHolder>
{
    Context context;
    ArrayList<Order> al;

    public PackedAdapter(Context context, ArrayList<Order> al) {
    ...
    @NonNull
    @Override
    public PackedAdapter.PackedAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View view= LayoutInflater.from(context).inflate(R.layout.packed_fragment_card,parent,false);
        return new PackedAdapter.PackedAdapterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PackedAdapter.PackedAdapterViewHolder holder, int position)
    {
        ...
        holder.confirmOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(context).setTitle("are you sure you want to shipeed this order").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i)
                    {
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                {
                                    Toast.makeText(context, "Order Shipeed", Toast.LENGTH_SHORT).show();
                                    al.remove(o);
